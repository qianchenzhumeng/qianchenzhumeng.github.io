...
在这篇博客中，我们在 Ubuntu 20.04.6 LTS 上从源码编译 RISC-V 工具链以及 QEMU，建立模拟开发环境，然后在这个基础上使用 VSCode 调试 FreeRTOS 的示例代码。实际上，从源码编译工具链很耗时而且从 github 克隆代码还会遇到网络问题，因此首选下载别人编译好的工具链，免去编译的繁琐工作。写这篇博客时，编译环境是 Ubuntu 20.04.6 LTS 的虚拟机，分配了 3 个 核，10G 内存，从下代码到最终编译成功，花了 1 天时间。
