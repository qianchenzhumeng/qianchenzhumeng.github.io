...
![image-20211007102418406](/assets/img/2017-11-14-generate_gerber_files_from_eagle.assets/image-20211007102418406.png)
...
![image-20211007113133798](/assets/img/2017-11-14-generate_gerber_files_from_eagle.assets/image-20211007113133798.png)

- 点击“添加”按钮，新建选项卡，将其名称改为“生成非电镀孔数据”，将文件后缀改为 hol，仅选中 45 Holes 层。 

![image-20211007113422048](/assets/img/2017-11-14-generate_gerber_files_from_eagle.assets/image-20211007113422048.png)
...
![image-20211007115157967](/assets/img/2017-11-14-generate_gerber_files_from_eagle.assets/image-20211007115157967.png)

- 点击“Silk screen CMP”选项卡，取消对 20 Dimension 层的选择。
- 点击“添加”按钮，新建选项卡，将名称改为“电路板外框”，将文件后缀改为“dim”，仅选中 20 Dimension 层。

![image-20211007115508897](/assets/img/2017-11-14-generate_gerber_files_from_eagle.assets/image-20211007115508897.png)
...
![image-20211007121450458](/assets/img/2017-11-14-generate_gerber_files_from_eagle.assets/image-20211007121450458.png)

- 点击“Options”按钮，修改配置，点击“确定”按钮，然后点击“Import”按钮导入。

![image-20211007121645224](/assets/img/2017-11-14-generate_gerber_files_from_eagle.assets/image-20211007121645224.png)
...
- 选中第五层，导入顶层丝印层文件（arduino_Uno_Rev3-02-TH.plc）：File->Import->Gerber...
  ...
  > 类似的，PCB 框外也会出现部分文字，原因是这些文字放在 25 tNames 层，如果需要处理的话，在 PCB 文件中删除或者放到其他不会被 CAM 处理器输出的层即可。

- 选中第六层，导入底层丝印层文件（arduino_Uno_Rev3-02-TH.pls）：File->Import->Gerber...

  > 同样的，将不需要的文字信息删掉或放在其他不会被 CAM 处理器输出的层。
...
![image-20211007125246240](/assets/img/2017-11-14-generate_gerber_files_from_eagle.assets/image-20211007125246240.png)
